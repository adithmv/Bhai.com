    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="bg-gray-900 rounded-2xl p-8 text-center max-w-md w-full">
        ...
        <div className="flex gap-3">
          <a href="/user/bookings" className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-xl transition text-center">
            View My Bookings
          </a>
          <a href="/user/browse" className="flex-1 bg-gray-800 hover:bg-gray-700 text-white font-semibold py-3 rounded-xl transition text-center">
            Browse More
          </a>
        </div>
      </div>
